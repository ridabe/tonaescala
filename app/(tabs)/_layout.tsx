...
import { CalendarDays, CalendarPlus, Bell, CircleUserRound, Plus, Wrench } from 'lucide-react-native';
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Ferramentas',
          tabBarIcon: ({ color, size }) => <Wrench size={size} color={color} strokeWidth={2} />,
        }}
      />
      <Tabs.Screen
        name="insights"
